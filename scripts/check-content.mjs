...
const structural = new Set([
  ...
  // Offices line and map pins reworded by the client, 8 September 2026.
  "Lagos, Abuja, Calabar, London",
  "abuja",
  "Abuja",
  "calabar",
  "Calabar",
  ...
  "left",
  "right",
  // Services kicker reworded by the client, 8 September 2026.
  "From product design to cloud delivery",
