...
- [ ] Detail `Visit`: `No. 3 Jasmine Road, Ikota GRA, Lekki, Lagos · United Kingdom` **(the label was renamed `Address` on 6 September 2026 at the client's instruction and the `Lagos` row label removed; the two locations sit beneath it as plain lines)**
