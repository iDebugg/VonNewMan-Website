...
export function TrustBand() {
  return (
    <Section ground="stone" labelledBy="trust-heading" className="py-[clamp(3rem,6vw,5rem)]">
      ...
      {/* The stats alone sit on the green: a forest panel inside the stone section. */}
      <dl
        data-ground="dark"
        className="mt-14 grid grid-cols-2 gap-y-8 bg-forest px-4 py-10 text-paper sm:px-8 lg:mt-16 lg:grid-cols-5 lg:gap-y-0 lg:py-12"
      >
        {stats.map((stat) => (
          <div
            key={stat.label}
