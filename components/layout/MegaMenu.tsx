  ...
  return (
    ...
    >
      <button
        ...
        className={cn(
          "inline-flex items-center gap-2 text-[0.875rem] leading-5 font-medium whitespace-nowrap transition-colors duration-150",
          appearance === "link" &&
      ...
      >
        {items.map((item, index) => (
          ...
          >
            ...
            >
              <span className="flex items-center gap-2 text-[0.875rem] leading-5 font-medium text-paper">
                {item.label}
